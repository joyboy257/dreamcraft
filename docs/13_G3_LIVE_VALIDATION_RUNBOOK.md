...
- Maximum serialized request envelope: `69,427` UTF-8 bytes per attempt, locked by test
...
- Conservative input projection: `69,427 × 20 × $5 / 1M = $6.9427`
- Maximum output projection: `80,000 × $30 / 1M = $2.4000`
- **Projected maximum: $9.3427 (round up to $9.35)**
...
- Stop immediately on authentication, quota, rate-limit, unexpected fallback, invalid world, or cumulative project spend reaching `$9.35`.
