...
- Maximum serialized request envelope: `70,349` UTF-8 bytes per attempt, locked by test
...
- Conservative input projection: `70,349 × 20 × $5 / 1M = $7.0349`
- Maximum output projection: `80,000 × $30 / 1M = $2.4000`
- **Projected maximum: $9.4349 (round up to $9.44)**
...
- Stop immediately on authentication, quota, rate-limit, unexpected fallback, invalid world, or cumulative project spend reaching `$9.44`.
